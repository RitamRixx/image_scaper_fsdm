...
import logging
import pymongo
logging.basicConfig(filename="scrapper.log" , level=logging.INFO) #create log file
import os
                ...
                try:
                    ...
                    for index,image_tag in enumerate(image_tags):
                                ...
                                with open(os.path.join(save_directory, f"{query}_{image_tags.index(image_tag)}.jpg"), "wb") as f:
                                    f.write(image_data)
                    client = pymongo.MongoClient("mongodb+srv://ritamrakshit33:ritam123@cluster0.xwlzegz.mongodb.net/?retryWrites=true&w=majority")
